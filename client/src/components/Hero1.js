...
const Hero = () => {
  ...
  return (
    <section className='h-full max-h-[850px] w-full bg-hero1 bg-right lg:bg-center bg-cover bg-no-repeat text-black pt-[225px] pb-[254px] relative mb-12 lg:mb-28'>
