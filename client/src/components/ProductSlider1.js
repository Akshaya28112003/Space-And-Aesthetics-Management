          ...
          <SwiperSlide key={index}>
            <div className='grid grid-cols-2 gap-x-5 md:grid-cols-3 lg:grid-cols-4 lg:gap-[30px]'>
              {page.productList.map((product, index) => {
                ...
                return (
                  <div
                    className='w-full max-w-[290px] h-[400px] text-left'
                    key={index}
                  >
                    <div className='border hover:border-accent rounded-[18px] w-full max-w-[285px] h-full max-h-[300px] flex items-center justify-center mb-[10px] relative transition'>
                      <img src={image.type} alt='' style={{height:'250px'}} />
